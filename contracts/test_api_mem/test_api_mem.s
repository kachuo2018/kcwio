...
.LBB5_2:
	...
	call    	kcwio_assert@FUNCTION, $pop1, $pop6
	i32.const	$push5=, 1
	i32.add 	$0=, $0, $pop5
	i32.const	$push4=, -1
...
_ZN20test_extended_memory16test_page_memoryEv:
	...
	call    	kcwio_assert@FUNCTION, $pop39, $pop40
	...
	call    	kcwio_assert@FUNCTION, $pop49, $pop50
	i32.const	$push55=, 0
...
_ZN20test_extended_memory25test_page_memory_exceededEv:
	...
	call    	kcwio_assert@FUNCTION, $pop8, $pop14
	i32.const	$push9=, 1
	i32.call	$push10=, _Z4sbrkj@FUNCTION, $pop9
	i32.const	$push11=, -1
	i32.eq  	$push12=, $pop10, $pop11
...
_ZN11test_memory18test_memory_allocsEv:
	...
	call    	kcwio_assert@FUNCTION, $pop51, $pop52
...
.LBB11_1:
	...
	call    	kcwio_assert@FUNCTION, $pop58, $pop209
	i32.const	$push208=, 1
	...
	call    	kcwio_assert@FUNCTION, $pop146, $pop147
	i32.eq  	$push148=, $3, $0
	i32.const	$push149=, .L.str.36
	call    	kcwio_assert@FUNCTION, $pop148, $pop149
	...
	call    	kcwio_assert@FUNCTION, $pop164, $pop165
	...
	call    	kcwio_assert@FUNCTION, $pop169, $pop170
	i32.lt_u	$push171=, $0, $3
	i32.const	$push172=, .L.str.44
	call    	kcwio_assert@FUNCTION, $pop171, $pop172
	.endfunc
.Lfunc_end11:
...
.LBB13_1:
	...
	call    	kcwio_assert@FUNCTION, $pop3, $pop34
	block   	
	i32.eqz 	$push53=, $3
	br_if   	0, $pop53
	...
	call    	kcwio_assert@FUNCTION, $pop5, $pop39
.LBB13_3:
	end_block
	copy_local	$3=, $1
	i32.const	$push43=, -1
...
.LBB14_3:
	...
	call    	kcwio_assert@FUNCTION, $pop12, $pop100
	...
	call    	kcwio_assert@FUNCTION, $pop16, $pop98
	i32.const	$push97=, 4
	...
	call    	kcwio_assert@FUNCTION, $pop18, $pop117
	...
	call    	kcwio_assert@FUNCTION, $pop23, $pop111
	...
	call    	kcwio_assert@FUNCTION, $pop28, $pop106
...
.LBB14_5:
	...
	call    	kcwio_assert@FUNCTION, $pop34, $pop129
	...
	call    	kcwio_assert@FUNCTION, $pop38, $pop127
	i32.const	$push126=, 4
...
.LBB14_7:
	...
	call    	kcwio_assert@FUNCTION, $pop45, $pop134
	block   	
	br_if   	0, $3
	i32.load	$push55=, 0($4)
	i32.eq  	$push56=, $0, $pop55
	i32.const	$push133=, .L.str.67
	call    	kcwio_assert@FUNCTION, $pop56, $pop133
	i32.const	$3=, 1
	br      	1
.LBB14_9:
	end_block
	...
	call    	kcwio_assert@FUNCTION, $pop49, $pop146
	i32.const	$push145=, 1
...
_ZN11test_memory18test_memset_memcpyEv:
	...
	call    	kcwio_assert@FUNCTION, $pop324, $pop323
	i32.const	$2=, 1
.LBB15_1:
	loop    	
	...
	call    	kcwio_assert@FUNCTION, $pop3, $pop334
	i32.const	$push333=, 1
	...
	call    	kcwio_assert@FUNCTION, $pop336, $pop335
	i32.const	$2=, 1
.LBB15_3:
	loop    	
	...
	call    	kcwio_assert@FUNCTION, $pop7, $pop341
	i32.const	$push340=, 1
...
.LBB15_5:
	...
	call    	kcwio_assert@FUNCTION, $pop281, $pop560
	i32.const	$push559=, 1
...
.LBB15_7:
	...
	call    	kcwio_assert@FUNCTION, $pop286, $pop565
	i32.const	$push564=, 1
...
.LBB15_9:
	...
	call    	kcwio_assert@FUNCTION, $pop292, $pop572
	i32.const	$push571=, 1
...
.LBB15_11:
	...
	call    	kcwio_assert@FUNCTION, $pop296, $pop579
	i32.const	$push578=, 1
...
.LBB33_22:
	...
	call    	kcwio_assert@FUNCTION, $pop117, $pop118
	br      	21
.LBB33_25:
	end_block
...
.LBB33_30:
	...
	call    	kcwio_assert@FUNCTION, $pop138, $pop137
	br      	17
.LBB33_31:
	end_block
	i32.const	$push46=, -1
...
.LBB33_35:
	...
	call    	kcwio_assert@FUNCTION, $pop85, $pop86
	...
	call    	kcwio_assert@FUNCTION, $pop96, $pop97
	br      	12
.LBB33_36:
	end_block
...
.LBB33_47:
	...
	call    	kcwio_assert@FUNCTION, $pop121, $pop122
.LBB33_48:
	end_block
	i32.const	$push145=, 0
...
realloc:
	...
	.result 	i32
	i32.const	$push0=, _ZN5kcwio11memory_heapE
	i32.call	$push1=, _ZN5kcwio14memory_manager7reallocEPvm@FUNCTION, $pop0, $0, $1
	.endfunc
.Lfunc_end38:
	.size	realloc, .Lfunc_end38-realloc

	.section	.text._ZN5kcwio14memory_manager7reallocEPvm,"axG",@progbits,_ZN5kcwio14memory_manager7reallocEPvm,comdat
	.hidden	_ZN5kcwio14memory_manager7reallocEPvm
	.weak	_ZN5kcwio14memory_manager7reallocEPvm
	.type	_ZN5kcwio14memory_manager7reallocEPvm,@function
_ZN5kcwio14memory_manager7reallocEPvm:
	.param  	i32, i32, i32
	.result 	i32
	.local  	i32, i32, i32, i32, i32
	i32.const	$push52=, 0
...
.LBB39_15:
	...
	i32.call	$push105=, _ZN5kcwio14memory_manager6memory16realloc_in_placeEPcmPm@FUNCTION, $2, $1, $3, $pop57
...
.LBB39_17:
	end_block
	i32.const	$4=, 0
	i32.call	$push75=, _ZN5kcwio14memory_manager6mallocEm@FUNCTION, $0, $3
...
.LBB39_28:
	...
	.endfunc
.Lfunc_end39:
	.size	_ZN5kcwio14memory_manager7reallocEPvm, .Lfunc_end39-_ZN5kcwio14memory_manager7reallocEPvm

	.section	.text._ZN5kcwio14memory_manager6memory16realloc_in_placeEPcmPm,"axG",@progbits,_ZN5kcwio14memory_manager6memory16realloc_in_placeEPcmPm,comdat
	.hidden	_ZN5kcwio14memory_manager6memory16realloc_in_placeEPcmPm
	.weak	_ZN5kcwio14memory_manager6memory16realloc_in_placeEPcmPm
	.type	_ZN5kcwio14memory_manager6memory16realloc_in_placeEPcmPm,@function
_ZN5kcwio14memory_manager6memory16realloc_in_placeEPcmPm:
...
.LBB40_19:
	...
	.endfunc
.Lfunc_end40:
	.size	_ZN5kcwio14memory_manager6memory16realloc_in_placeEPcmPm, .Lfunc_end40-_ZN5kcwio14memory_manager6memory16realloc_in_placeEPcmPm
